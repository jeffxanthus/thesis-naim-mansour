function [An,bn,nr] = noredund(A,b,c)
...
%
% Modified version: Does not search for a feasible point. Feasible point
% given in c. Original file found at: 
% 
% [An,bn] = noredund(A,b,c)
% 
% For n variables:
