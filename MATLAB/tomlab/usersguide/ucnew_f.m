...
elseif P == 5	% Fletcher exercise 2.3
    % X=(0,0) sadle; x = (0,-1) sadle; x = (1,0) local min; x = (-1,-1)
    % local max
...
% 990920   hkh   Added extra test problem RB BANANA, for User' Guide
