% NLPINF Nonlinear Maximum Norm Matlab Solver
% -----------------------------------------------------------------------
%
%   NLPINF solves the following nonlinear constrained maximum norm 
%   programming problem:
%
...
%   IF RUNNING TOMLAB:
%
%   Correct input is generated in nlpinfTL.m from Prob input.
%   nlpinf is called using the driver routine tomRun, or nlpinfTL
%
%   IF NOT RUNNING TOMLAB:
%
%           If TOMLAB calls nlpinf, then Prob is the standard
...
%                [dc]    = func(x,Prob)
%
%           NLPINF is calling the TOMLAB routines nlresid.m and nlJac.m
...
%
% PrintFile The name of the file to be used for NLPINF solver information 
%           output.
%
