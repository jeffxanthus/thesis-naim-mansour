% function [f,g] = smoothmax(x, y, delta)
%
% smoothmax is a smooth approximation to max(x,y) when delta > 0.
...
%
% 23 Jan 2003: Derived by Philip Gill.
% 24 Jan 2003: Gradient g added as output vector.
% 26 Jan 2003: Polished a bit (MAS).
%
% INPUT:
% x           Value 1
% y           Value 2
