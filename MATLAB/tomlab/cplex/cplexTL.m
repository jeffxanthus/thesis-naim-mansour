...
% Copyright (c) 1999-2009 by Tomlab Optimization Inc., $Release: 12.1.0$
% Written July 8, 1999.      Last modified Aug 12, 2009.
...
Unsafe   = DefPar(CPLEX,'Unsafe',0);

cpxSettings = struct('tune',Tune,'presolve',Presolve,'unsafe',Unsafe);

[x, slack, v, rc, f_k, ninf, sinf, Inform, basis, lpiter, glnodes, ...
   confstat, iconfstat, sa, cpxControlOut, presolve, kappa ] = ...
