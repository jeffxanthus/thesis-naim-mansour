% function ret = cpxcb_PRIMCROSS(cpxCBInfo)
%
% CPLEX Primal crossover callback
%
% Called from TOMLAB /CPLEX during the primal crossover algorithm.
%
% This callback is enabled by setting callback(3)=1 in the call to
% cplex.m, or Prob.MIP.callback(3)=1 if using tomRun('cplex',...)
%
