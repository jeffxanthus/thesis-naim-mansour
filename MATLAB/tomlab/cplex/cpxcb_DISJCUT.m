% function ret = cpxcb_DISJCUT(cpxCBInfo)
%
% CPLEX Disjunctive cut callback
%
% Called from TOMLAB /CPLEX during disjunctive cuts processing
%
% This callback is enabled by setting callback(10)=1 in the call to
% cplex.m, or Prob.MIP.callback(10)=1 if using tomRun('cplex',...)
%
