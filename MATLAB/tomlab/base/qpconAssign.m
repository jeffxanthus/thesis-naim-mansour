% qpconAssign implements the TOMLAB (TQ) format for nonlinearly
% constrained QP problems.
%
% qpconAssign sets the variables normally needed for an optimization in
...
% -----------------------------------------------------
%
% Syntax of qpconAssign:
%
% function Prob = qpconAssign(F, d, x_L, x_U, Name, x_0, ...
                                       ...
                                       if nargin < 7
                                          ...
                                          if nargin < 6
                                             ...
                                             if nargin < 5
                                                Name=[];
                                                if nargin < 4
                    error('qpconAssign requires at least four parameters');
...
Prob = tomFiles(Prob, 'qp_f', 'qp_g', 'qp_H', c, dc, d2c);
...
% 050117  med  One extra end removed
% 050613  hkh  Change Q to F and f to d
