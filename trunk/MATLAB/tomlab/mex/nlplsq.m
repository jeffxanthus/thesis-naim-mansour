% NLPLSQ Nonlinear Least Squares Matlab Solver
% -----------------------------------------------------------------------
%
%   NLPLSQ solves the following nonlinear constrained min-max programming 
%   problem:
%
%   minimize    ( f_1(x)^2 + ... + f_L(x)^2 )
%      x
...
%   IF RUNNING TOMLAB:
%
%   Correct input is generated in nlplsqTL.m from Prob input.
%   nlplsq is called using the driver routine tomRun, or nlplsqTL
%
%   IF NOT RUNNING TOMLAB:
%
%           If TOMLAB calls nlplsq, then Prob is the standard
...
%                [dc]    = func(x,Prob)
%
%           NLPLSQ is calling the TOMLAB routines nlresid.m and nlJac.m
...
%
% PrintFile The name of the file to be used for NLPLSQ solver information 
%           output.
%
