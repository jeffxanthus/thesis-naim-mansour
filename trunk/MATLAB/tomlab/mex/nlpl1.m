% NLPL1 Nonlinear L1-norm Matlab Solver
% -----------------------------------------------------------------------
%
%   NLPL1 solves the following nonlinear constrained L1-norm programming 
%   problem:
%
%   minimize    | f_1(x) | + ... + | f_L(x) |
%      x
...
%   IF RUNNING TOMLAB:
%
%   Correct input is generated in nlpl1TL.m from Prob input.
%   nlpl1 is called using the driver routine tomRun, or nlpl1TL
%
%   IF NOT RUNNING TOMLAB:
%
%           If TOMLAB calls nlpl1, then Prob is the standard
...
%                [dc]    = func(x,Prob)
%
%           NLPL1 is calling the TOMLAB routines nlresid.m and nlJac.m
...
%
% PrintFile The name of the file to be used for NLPL1 solver information 
%           output.
%
