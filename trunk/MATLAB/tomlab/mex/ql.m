...
% -----------------------------------------------------------------------
%
%   QL solves the following convex quadratic programming problem (QP):
%
...
%   IF RUNNING TOMLAB:
%
%   Correct input is generated in qlTL.m from Prob input.
%   ql is called using the driver routine tomRun, or qlTL
%
% ------------------------------------------------------------------------
%
% function [x, Inform, Iter, iState, Ax, cLamda, Obj] = ql ( ...
%         H, A, b, mEQ, c, x_L, x_U, PriLev, PrintFile, ql_eps);
%
...
% PrintFile Name of the print file.
% ql_eps    Desired final accuracy. Default is the macine precision.
%
% OUTPUT:
% x         Solution vector with decision variable values (n x 1 vector).
% Inform    Result of QL run.
