...
% Copyright (c) 2000-2011 by Tomlab Optimization Inc., $Release: 8.0.0$
% Written July 4, 2000.   Last modified Sept 14, 2011.
...
Result.Solver='snopt';
Result.SolverAlgorithm='SNOPT 7.2-5 NLP code';
...
% 091207 hkh  Set nnJac to only nonlinear variables, squeeze gJac, save huge CPU time if many linear variables
