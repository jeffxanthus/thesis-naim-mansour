...
%                   Hessian calculation
%                3  Preconditioned CG method with exact Hessian not
%                   expclitly assembled.
%
...
% Copyright (c) 2003-2008 by Tomlab Optimization Inc., $Release: 6.2.0$
% Written Jan 17, 2003.  Last modified Jun 7, 2008.

function Result = penbmiTL(Prob)

%#function lp_f lp_g lp_H

if nargin < 1, error('penbmiTL needs the Prob structure as input');end
...
Result.SolverAlgorithm='BMI Solver PENBMI 2.1';
...
% 070628 ango Minor help changes related to PENBMI 2.1
