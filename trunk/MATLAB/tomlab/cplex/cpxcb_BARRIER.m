% function ret = cpxcb_BARRIER(cpxCBInfo)
%
...
% barrier algorithm. 
%
% This callback is enabled by setting callback(5)=1 in the call to
% cplex.m, or Prob.MIP.callback(5)=1 if using tomRun('cplex',...)
%
...
%
% By returning a nonzero value from cpxcb_BARRIER, the user can terminate
% the optimization.
%
...
% Written Sept 22, 2002   Last modified Jan 30, 2006
