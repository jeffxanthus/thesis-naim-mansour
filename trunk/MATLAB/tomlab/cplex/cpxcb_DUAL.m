% function ret = cpxcb_DUAL(cpxCBInfo)
%
...
%
% This callback is enabled by setting callback(2)=1 in the call to
% cplex.m, or Prob.MIP.callback(2)=1 if using tomRun('cplex',...)
%
...
%
% By returning a nonzero value from cpxcb_DUAL, the user can terminate
% the optimization.
%
...
% Written Sept 22, 2002   Last modified Jan 29, 2006.
