...
%
% Called from TOMLAB /CPLEX during mixed integer optimization when a new
% integer solution has been found but before this solution has replaced
% the current best known integer solution.
%
...
% or continue the optimization, and also whether to accept or discard the
