% function ret = cpxcb_FLOWMIR(cpxCBInfo)
%
% CPLEX Mixed integer rounding cut callback
%
% Called from TOMLAB /CPLEX during Mixed integer rounding cuts processing
%
% This callback is enabled by setting callback(11)=1 in the call to
% cplex.m, or Prob.MIP.callback(11)=1 if using tomRun('cplex',...)
%
