...
% Copyright (c) 2002-2009 by Tomlab Optimization Inc., $Release: 11.2.0$
% Written Aug 5, 2002.    Last modified Aug 4, 2009.
...
try
   [x, slack, v, rc, f_k, ninf, sinf, Inform, basis, lpiter, glnodes,...
      iconfstat, sa, cpxControl, presolve ] ...
      = cplexmex11(double(c), sparse(F), sparse(A), callback , x_L, x_U, b_L, b_U,...
