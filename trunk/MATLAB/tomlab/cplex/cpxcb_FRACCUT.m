% function ret = cpxcb_FRACCUT(cpxCBInfo)
%
% CPLEX Gomory fractional cut callback
%
% Called from TOMLAB /CPLEX during Gomory fractional cuts processing
%
% This callback is enabled by setting callback(9)=1 in the call to
% cplex.m, or Prob.MIP.callback(9)=1 if using tomRun('cplex',...)
%
