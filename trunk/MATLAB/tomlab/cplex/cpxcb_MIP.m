% function ret = cpxcb_MIP()
%
% CPLEX MIP callback
%
% Called from TOMLAB /CPLEX during mixed integer optimization
%
% This callback is enabled by setting callback(7)=1 in the call to
% cplex.m, or Prob.MIP.callback(7)=1 if using tomRun('cplex',...)
%
...
function ret = cpxcb_MIP(cpxCBInfo)
