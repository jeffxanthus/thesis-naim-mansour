% function ret = cpxcb_PRIM(cpxCBInfo)
%
...
%
% This callback is enabled by setting callback(1)=1 in the call to
% cplex.m, or Prob.MIP.callback(1)=1 if using tomRun('cplex',...)
%
...
%
% By returning a nonzero value from cpxcb_PRIM, the user can terminate
% the optimization.
%
