% function ret = cpxcb_QPSIMPLEX(cpxCBInfo)
%
...
%
% This callback is enabled by setting callback(13)=1 in the call to
% cplex.m, or Prob.MIP.callback(13)=1 if using tomRun('cplex',...)
%
% cpxcb_QPSIMPLEX is called with one argument, the cpxCBInfo
...
% Written Jan 30, 2006   Last modified Feb 2, 2006 
