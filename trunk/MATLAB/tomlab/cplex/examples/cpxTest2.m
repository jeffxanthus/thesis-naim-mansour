...
%
% Define sos1 constraints
%
% function x = cpxTest2(DEFPARAM)
%
...
[c,x_L,x_U,b_L,b_U,A,sos1]=abc2gap(A,b,C,1);
% [c,x_L,x_U,b_L,b_U,A]=abc2gap(A,b,C,0);

IntVars=[];  % No binary variables specified, instead sos1 variables. 
% IntVars = [1:length(c)];
% sos1=[];
...
Prob.P = 2;  % Initialize Prob with problem number 2
